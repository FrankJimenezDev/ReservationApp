...
RESERVES.user_id, USERS.name, USERS.lastname, ROOMS.room_id, ROOMS.price, CURRENCY.currency_name, ROS.status_name as room_status, 
...
JOIN CURRENCY on ROOMS.currency_id=CURRENCY.currency_id;